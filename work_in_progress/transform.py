...
def drop_columns(data: pd.DataFrame) -> pd.DataFrame:
    ...
    # data = data.reset_index(drop=True)
    data = data.drop(columns=['Region','Population','Waste And Sewage','Machinery','Electricity And District Heating','Other Heating','Agriculture','Transportation','Industry'])
    data = data.reset_index(drop=True)
    return data
